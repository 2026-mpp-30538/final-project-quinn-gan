...
# --- STEP 6: SAVE FINAL INTEGRATED DATASET ---
# This is the "Derived Data" that combines both CMS and ACS info
derived_dir = "data/derived-data"
os.makedirs(derived_dir, exist_ok=True)

# Define the final filename
final_output_path = os.path.join(derived_dir, "cms_acs_merged_2023.csv")

# Save to CSV
# index=False prevents pandas from adding an extra 'Unnamed: 0' column
merged_df.to_csv(final_output_path, index=False)

print(f"Success! Processed data for analysis saved at: {final_output_path}")
```
